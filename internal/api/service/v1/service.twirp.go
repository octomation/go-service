...
func NewGreeterServiceProtobufClient(baseURL string, client HTTPClient, opts ...twirp.ClientOption) GreeterService {
	...
	serviceURL += baseServicePath(pathPrefix, "api.service.v1", "GreeterService")
	urls := [2]string{
		serviceURL + "Hello",
		serviceURL + "Sign",
	}
...
func (c *greeterServiceProtobufClient) Hello(ctx context.Context, in *HelloRequest) (*HelloResponse, error) {
	ctx = ctxsetters.WithPackageName(ctx, "api.service.v1")
...
const GreeterServicePathPrefix = "/twirp/api.service.v1.GreeterService/"
...
func (s *greeterServiceServer) ServeHTTP(resp http.ResponseWriter, req *http.Request) {
	...
	if pkgService != "api.service.v1.GreeterService" {
...
func (s *greeterServiceServer) PathPrefix() string {
	return baseServicePath(s.pathPrefix, "api.service.v1", "GreeterService")
}
...
var twirpFileDescriptor0 = []byte{
	...
	0x4b, 0xf2, 0x85, 0xf8, 0x12, 0x0b, 0x32, 0xf5, 0x60, 0x42, 0x65, 0x86, 0x4a, 0x1a, 0x5c, 0x3c,
	...
	,
}
